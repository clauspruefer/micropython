...
The compiler flag `-O3` for performance is enabled.
...
set_property(TARGET micropython_lib PROPERTY IMPORTED_LOCATION /usr/local/lib/esp32c3/libmicropython.a)
