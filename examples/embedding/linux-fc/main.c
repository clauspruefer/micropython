...
// This example demonstrates the math module.
static const char *example_math =
    "import math\n"
    "print('sqrt(2) =', math.sqrt(2))\n"
    "print('round(3.567, 1) =', round(3.567, 1))\n"
;
...
int main() {
    ...
    mp_embed_exec_str(example_math);

    // Run example 3: call myfunction(jsonstring) and print the result.
    mp_embed_exec_str(example_3);
    const char *result = mp_embed_exec_string_function("myfunction", example_3_function_string);
    if (result) {
